...
import pacman.controllers.zoe_winkworth.Evolutionary_Controller;
...
{	
	...
	public static void main(String[] args)
	{
		...
		/*int numTrials=20;
		exec.runExperiment(new DFS_Controller(),new StarterGhosts(),numTrials);*/
		...
		int delay=15;
		boolean visual=true;
		exec.runGame(new Evolutionary_Controller(),new StarterGhosts(),visual,delay);
