...
# run lead
#time /opt/python-3.6/bin/python3 run_summarization.py "$DATA_DIR"/GuidedSumm11_test_topics.xml lead --first_method first_sentence --output_dir ../outputs/D4_evaltest/
# evaluate lead
...
# run mead
time /opt/python-3.6/bin/python3 run_summarization.py "$DATA_DIR"/GuidedSumm11_test_topics.xml mead --first_method first_sentence --output_dir ../outputs/D4_evaltest/
# evaluate mead
...
# run melda
#time /opt/python-3.6/bin/python3.6 run_summarization.py "$DATA_DIR"/GuidedSumm11_test_topics.xml melda --first_method first_sentence --output_dir ../outputs/D4_evaltest/
## evaluate melda
